...
public class String02LongString {
	...
	public static void main(String[] args) { // m s
		...
		String[] sp = str.split(" ");
		System.out.println("분리된 단어의 개숫는 : "+sp.length);
...
/*
		String[] sp1 = str.split("HTML5");
		System.out.println("HTML5단어 개수는 : "+sp1.length);
		
		for (String resultNum : sp1) {
			
		}
		*/
		
		//for문을 활요하여 역순으로 출력하기
		String tempString = "우리는 세종대왕이 만든 빛나는 문화유산인 한글을 갖고 있다.";
		String[] arrStr=tempString.split(" ");
		for (int i = arrStr.length-1; i >=0; i--) {	// 인덱스는 0부터시작하기때문에 0,1,2,3,4 | length 5이기 때문에 -1을 해줌
			System.out.println(arrStr[i]+" ");
		}
		System.out.println();

		// 문제 2. 위 str 데이터를 모두 역순 (space기준)으로 
		// resultStr변수 저장하여 출력
